#import global_bindings::{GlobalUniforms, VertexInput, globals, norm_sqr, powc, norm, cis, cinv, cmul, dpowc, dnorm_sqr, dnorm, arg, darg, max_iterations, croot, colormap2};
